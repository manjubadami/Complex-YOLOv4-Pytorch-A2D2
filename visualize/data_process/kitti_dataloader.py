...
if __name__ == '__main__':
    ...
    configs.dataset_dir = os.path.join('../../', 'dataset', 'a2d2')
    ...
    for batch_i, (img_files, imgs, targets) in enumerate(dataloader):
        if not (configs.mosaic and configs.show_train_data):
            ...
            objects_pred = invert_target(targets[:, 1:], img_rgb.shape, RGB_Map=None)
            img_rgb = show_image_with_boxes(img_rgb, objects_pred, False)
